...
int main(void) {
    ...
    int board_width = 800, height = 800;
    ...
    {   0 * board_height / 8, 1 * board_height / 8, 2 * board_height / 8, 3 * board_height / 8, 4 * board_height / 8, 5 * board_height / 8, 6 * board_height / 8, 7 * board_height / 8};
